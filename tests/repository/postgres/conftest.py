...
def pg_session(pg_session_empty, pg_test_data):
    ...
    # Note that this fixture has a function scope, we delete all rooms after the yield returns. 
    # which leaves the database exactly as it was before the test (clean up after tests).

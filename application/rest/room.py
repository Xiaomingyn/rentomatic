...
# For In-Memory repository only
#from rentomatic.repository.memrepo import MemRepo

# For PostgresDB repository only
...
def room_list():
    ...
    # For PostgresDB repository only
    # As the external database will not contain any data initially, the response of the use case will be empty
